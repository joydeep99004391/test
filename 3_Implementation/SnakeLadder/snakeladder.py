#
# COMPILER based snake and ladder game
 # @author  : ankit sharma
...
def check_win(player_name, position):
    ...
    if MAX_VAL == position:
        ...
        if player_name != 'Ai':
               leaderboard_obj.addplayer({'name':player_name,'game_name':'snake and ladder ', 'points':100,'duration':'15 mins'})
